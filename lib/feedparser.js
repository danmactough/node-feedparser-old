...
function feedParser2 () {
  events.EventEmitter.call(this);
}

util.inherits(feedParser2, events.EventEmitter);
 ...
 */
feedParser2.prototype.parseString = function(string) {
  var self = this;
...
feedParser2.prototype.parseFile = function(file) {
  var self = this;
  function cb(meta, articles) {
    if (articles.length) {
      articles.forEach(function(article){
...
exports.FeedParser = feedParser2;
